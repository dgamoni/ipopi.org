...
if($responsive)
{
 ...
 //    $search = '<div class="mobilheadersearch headersearch avia-search-tooltip avia-tt">';
 //    	$search .= '<div class="inner_tooltip">'.$form_search.'</div>';
 //    $search .= '</div>';
 //    echo $search;
...
$header_topbar_for_child = false;
if($headerS['header_topbar'] == true && $header_topbar_for_child)
{
?>
				 ...
				 $output .= "<div class='container av-logo-container'>";
					...
					$output .= "<div class='inner-container'>";
						...
						*/
					        ...
					        $items = '<div class="headersearch avia-search-tooltip avia-tt">';
					        	$items .= '<div class="inner_tooltip">'.$form.'</div>';
					        $items .= '</div>';

							$output .= "<div class='preheader'>";
								$output .= "<h3 class='blog-description'>".get_bloginfo('description', 'display').'</h3>';
								$output .= $items;
							$output .= "</div>";

							$output .= "<div class='menu_wrap'>";
							    $output .= "<nav class='ipopimainmenu main_menu' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
							    ...
							    */
								...
								$output .= "<nav class='ipopimainmenu_sub sub_menu' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
								$output .= $nav;
								$output .= '</nav>';
							$output .= "</div>";
							//end menu_wrap
